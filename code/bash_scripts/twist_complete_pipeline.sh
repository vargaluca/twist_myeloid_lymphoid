...
covered='/disk/work/diagnostics/TWLM/lv1/twist_myeloid_lymphoid/bed_files/updated_2024'
	...
	for bamfile in *sorted.bam
		do
        	...
        	qualimap bamqc -bam $bamfile -outdir $path/bam_qc/$run/$outdir -gff $covered/*bed --java-mem-size=4G
